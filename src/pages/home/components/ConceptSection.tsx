    ...
    <section ref={sectionRef} id="concept" className="relative w-full py-24 md:py-32 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-16">
        <div className="flex flex-col lg:flex-row items-center gap-6">
          ...
          <div
            className={`flex-1 w-full max-w-xl lg:max-w-none transition-all duration-800 delay-200 ease-out ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-12'
              }`}
          >
            <img
              src={about}
